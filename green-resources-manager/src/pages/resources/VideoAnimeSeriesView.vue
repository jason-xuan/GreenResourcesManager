  ...
  data() {
    return {
      ...
      videoContextMenuItems: [
        ...
        { key: 'play', icon: '▶️', label: '播放番剧' },
        { key: 'folder', icon: '📁', label: '打开文件夹' },
        { key: 'edit', icon: '✏️', label: '编辑信息' },
        { key: 'remove', icon: '🗑️', label: '删除番剧' }
      ],
      ...
      videoEmptyStateConfig: {
        emptyIcon: '📺',
        emptyTitle: '你的番剧库是空的',
        emptyDescription: '点击"添加番剧"或"添加文件夹"按钮来添加内容，或直接拖拽视频文件/文件夹到此处（支持多选）',
        emptyButtonText: '添加第一个番剧',
    ...
    videoActions() {
      if (this.selectedVideo?.type === 'folder') {
        ...
        const actions = [
          ...
          { key: 'folder', icon: '📁', label: '打开文件夹', class: 'btn-open-folder' },
          { key: 'edit', icon: '✏️', label: '编辑信息', class: 'btn-edit-game' },
          { key: 'remove', icon: '🗑️', label: '删除番剧', class: 'btn-remove-game' }
        ]
